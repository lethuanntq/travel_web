<div class="mt-5 container border">
    ...
    <div class="mt-3">
        <div>
            ...
            <div class="invalid-feedback">{{ $errors->first("account.email") }}</div>
        </div>
    </div>
    <div class="mt-3">
        <div>
            ...
            <div class="invalid-feedback">{{ $errors->first("account.phone_number") }}</div>
        </div>
    </div>
    <div class="mt-3">
        <div>
            ...
            <div class="invalid-feedback">{{ $errors->first("account.password") }}</div>
        </div>
    </div>
    <div class="mt-3">
        <div>
            ...
            <div class="invalid-feedback">{{ $errors->first("account.password_confirm") }}</div>
        </div>
    </div>
    <div class="mt-3">
            <div>
            ...
            @endforeach
            <div class="invalid-feedback">{{ $errors->first("account.role") }}</div>
    </div>
    <div class="mt-3">
        <div>
            <div>
            ...
            <div class="invalid-feedback">{{ $errors->first("account.active") }}</div>
        </div>
    </div>
    <div class="mt-3">
