        ...
        <div class="row mb-3">
            <div class="col-sm-3 mt-sm-5">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item">Tổng số biên tập viên: <a href="{{ route('management.account.index') }}">{{ \App\Models\User::where('role', \App\Models\User::ROLE_EDITOR)->count() }}</a></li>
